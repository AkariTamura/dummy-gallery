          ...
          <!-- 本文 -->
            ...
            >
              <div class="story-line-item">
                ...
                ></p>
                <button class="copy-btn" :class="{ 'img-button': !!story.img }" @click="copyText(story.data)"></button>
              </div>
              <div class="story-line-kp" v-html="formatTextKp(story.kp)" v-if="story.kp"></div>
            </div>
            <hr>
        </div>
      </div>
