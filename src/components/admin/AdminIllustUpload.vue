<template>
  <div class="container">
    ...
    <form class="panel" @submit.prevent="submit">
      <div class="form-row">
        <label>ファイル <span class="required">*</span></label><br>
      ...
      <div class="form-row">
        <label>タイトル <span class="required">*</span></label><br>
      ...
      <div class="form-row">
        <label>キャプション <span class="required">*</span></label><br>
      ...
      <div class="form-row">
        <label>登録日 <span class="required">*</span></label><br>
...
const { file, title, caption, created_ymd, tags, hide_flg, hide_Q, hide_A, errors, submit: composableSubmit, reset } = useAdminIllustUpload()
...
.panel { border:1px solid #ccc; padding:12px; border-radius:4px; }
.form-row { margin-bottom:12px; }
.form-row-inline { display:flex; align-items:center; gap:8px; margin-bottom:12px; }
.input-full { width:100%; padding:6px; box-sizing:border-box; }
.input-small { width:140px; padding:6px; box-sizing:border-box; }
.textarea-large { width:100%; height:120px; padding:6px; box-sizing:border-box; }
.textarea-small { width:100%; height:80px; padding:6px; box-sizing:border-box; }
.required { color:#d00; }
.error-text { color:#d00; font-size:0.85em; margin-top:4px; }
.error-text.bold { font-weight:600; }
